  ...
  return (
    <>
      <div className="p-6 space-y-4">
        <div>
          <h1 className="text-lg font-semibold text-text-primary">Copy Trade Management</h1>
          <p className="text-xxs text-text-tertiary mt-0.5">Copy Trade, PAMM, and Signal Provider management</p>
        </div>
              ...
              <div className="p-4 space-y-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {[
                    ...
                    { label: 'Copy Masters', value: String(pammAnalytics.summary.total_mam_managers), icon: Users, color: 'text-text-primary' },
                ...
                {/* Copy Masters */}
                <div>
                  <h3 className="text-xs font-semibold text-text-primary mb-2">Copy Masters</h3>
                  {pammAnalytics.mam_managers.length === 0 ? (
                    <p className="text-xxs text-text-tertiary py-6 text-center">No copy masters yet</p>
                  ) : (
                    <div className="overflow-x-auto rounded-md border border-border-primary">
                      <table className="w-full">
                        <thead><tr className="border-b border-border-primary bg-bg-tertiary/40">
            ...
            <div className="p-4 space-y-3">
              ...
              <div>
                ...
                <select value={approveType} onChange={e => setApproveType(e.target.value)} className="w-full text-xs py-2 pl-3 pr-8 appearance-none bg-bg-input border border-border-primary rounded-md text-text-primary">
                  ...
                  <option value="mamm">Copy Trade (Multi-Account)</option>
                </select>
              </div>
