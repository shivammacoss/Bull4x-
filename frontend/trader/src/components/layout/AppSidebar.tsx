...
const NAV_ITEMS = [
  ...
  { label: 'Copy Trade', href: '/social', icon: Copy },
  { label: 'Affiliates', href: '/business', icon: Users },
  { label: 'Bull4x Academy', href: '/academy', icon: GraduationCap },
  ...
  { label: 'Desktop Terminal', href: '/desktop-terminal', icon: Monitor },
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-3 gap-2">
          <Link href="/dashboard" className="flex items-center gap-2 min-w-0">
            <span className="inline-flex items-baseline font-bold italic tracking-tight text-xl select-none">
              ...
              <span className="text-[#2196f3]">4x</span>
            </span>
          </Link>
          <button
            type="button"
