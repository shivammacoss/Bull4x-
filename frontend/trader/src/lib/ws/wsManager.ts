...
class WSManager {
  ...
  private scheduleReconnect(token?: string) {
    ...
    // Cap the backoff at 5 seconds — going to 30s blacks out the price feed
    // long enough that the trader's quotes are dangerously stale by the time
    // we reconnect. We'd rather hammer the gateway briefly than let a trader
    // click BUY at a 30-second-old price.
