  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'Best execution speeds I\'ve experienced. Bull4x has transformed my trading with their reliable platform and tight spreads.'
    },
    {
  ...
  return (
    <div className="min-h-screen pt-20">
        ...
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Why Thousands Choose Bull4x
            </h1>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Discover what makes Bull4x the preferred choice for traders worldwide.
            </p>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="container-custom">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="text-text-secondary text-center mb-12 max-w-2xl mx-auto">
              Don't just take our word for it. Here's what our clients have to say about their experience with Bull4x.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="fadeUp">
            <div className="glass-card p-12 text-center max-w-4xl mx-auto">
              ...
              <p className="text-text-secondary text-lg mb-8">
                Bull4x is an authorised and regulated forex and CFD brokerage. Client funds are
                held in segregated accounts at tier-1 banks, with negative balance protection on
                every live trading account.
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-card p-6">
                  <h3 className="text-xl font-semibold text-white mb-2">FCA Authorised</h3>
                  <p className="text-text-secondary">United Kingdom</p>
                </div>
                <div className="glass-card p-6">
                  <h3 className="text-xl font-semibold text-white mb-2">CySEC Regulated</h3>
      ...
      <section className="section-padding bg-gradient-hero">
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            <h2 className="text-4xl font-bold text-white mb-6">Experience the Bull4x Difference</h2>
            <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
              Join thousands of active traders across 90+ countries on a regulated platform built for serious execution.
            </p>
