      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <StatBox value="$5M+"    label="Withdrawals Paid" />
          ...
          <div className="flex flex-wrap justify-center gap-8 text-primary-bg">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">Same-day withdrawals in USD, EUR, GBP, USDT</span>
            </div>
            <div className="flex items-center gap-2">
              <Lock className="w-6 h-6 text-primary-accent" />
              <span className="font-semibold">FCA &amp; CySEC Authorised Brokerage</span>
            </div>
            <div className="flex items-center gap-2">
              <Globe className="w-6 h-6 text-primary-accent" />
              <span className="font-semibold">24/5 Multilingual Support</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary-secondary">
        <div className="container-custom">
          ...
          <div className="text-center">
            <Link to="/company/why-bull4x" className="inline-flex items-center gap-2 text-primary-accent hover:text-white transition-colors font-semibold text-lg">
      ...
      <section className="section-padding bg-gradient-hero relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
            Join thousands of forex traders accessing tier-1 liquidity, sub-30ms execution, and same-day withdrawals.
          </p>
