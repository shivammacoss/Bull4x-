...
const Footer = () => {
  const footerLinks = {
    ...
    platforms: [
      ...
      { name: 'Cashback Rewards', path: '/platforms/prop-trading' },
    ...
    company: [
      ...
      { name: 'Why Bull4x', path: '/company/why-bull4x' },
        ...
        <ScrollReveal variant="fadeIn" delay={0.5}>
          <div className="pt-8 border-t border-white/5 space-y-3">
            <p className="text-text-secondary text-xs text-center">
              © 2026 Bull4x. All rights reserved.
            </p>
            <p className="text-text-secondary text-xs text-center max-w-3xl mx-auto leading-relaxed">
              Bull4x is an authorised and regulated forex and CFD brokerage. CFDs are leveraged
              instruments and carry a high level of risk to your capital. Past performance does not
              guarantee future results. Trading involves substantial risk and is not suitable for every investor.
            </p>
          </div>
        </ScrollReveal>
      </div>
