        ...
        <AnimatedSection animation="slideUp" delay={0.3}>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              <Link to="/platforms/web" className="b4x-btn-primary gap-2">Explore Platform <ArrowRight size={16} /></Link>
              <Link to="/auth/register" className="b4x-btn-outline gap-2">Try Demo</Link>
            </div>
          </div>
        </AnimatedSection>
      </div>
