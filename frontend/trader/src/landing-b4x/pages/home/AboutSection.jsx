...
import { ArrowRight, Shield, Zap, Target, Swords } from 'lucide-react'
          ...
          <AnimatedSection animation="slideLeft">
            <div className="relative">
              ...
              >
                ...
                {/* Katana motif — Lucide icon, monochromatic */}
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <Swords className="w-52 h-52 text-white opacity-[0.12]" strokeWidth={1} />
                </div>
