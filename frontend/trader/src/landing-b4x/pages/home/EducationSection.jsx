        ...
        <div className="mt-10 mb-10 p-6 rounded-2xl bg-gradient-to-r from-red-accent/10 to-bull-600 border border-red-accent/20 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            ...
            <div className="flex flex-wrap gap-3 md:justify-end">
              <Link to="/education/tutorials" className="b4x-btn-primary gap-2">Explore Education <ArrowRight size={16} /></Link>
              <Link to="/auth/register" className="b4x-btn-outline gap-2">Start Demo</Link>
            </div>
          </div>
        </div>
