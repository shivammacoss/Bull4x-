...
import { Link, NavLink, useLocation } from '../router-shim'
...
const navItems = [
  ...
  { label: 'Trading',        path: '/our-trading',          icon: <BarChart2 /> },
  { label: 'Platforms',      path: '/platforms/web',        icon: <Monitor /> },
  { label: 'Accounts',       path: '/our-accounts',         icon: <User /> },
  { label: 'Education',      path: '/education/tutorials',  icon: <Book /> },
  { label: 'About',          path: '/company/about',        icon: <Info /> },
