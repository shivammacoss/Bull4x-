...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-[#0C0C1D] py-14 md:py-24 px-6 relative overflow-hidden">
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-[rgba(1,88,198,0.06)] rounded-full blur-[100px] pointer-events-none" />
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={formRef} className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div ref={headerRef} className="scroll-reveal flex flex-col justify-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[rgba(1,88,198,0.1)] border border-[rgba(1,88,198,0.2)] mb-5 w-fit">
              <span className="w-1.5 h-1.5 rounded-full bg-[#0158c6]" />
              <span className="text-xs font-semibold text-[#0158c6] uppercase tracking-widest">Contact Us</span>
            </div>
            <h2
            ...
            >
              Contact Our{' '}
              <span className="text-[#0158c6]">Support</span> Team
            </h2>
              ...
              {contactMethods.map((method) => {
                ...
                return (
                  <div key={method.label} className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[rgba(1,88,198,0.1)] border border-[rgba(1,88,198,0.2)] flex items-center justify-center shrink-0">
                      <Icon size={18} className="text-[#0158c6]" />
                    </div>
                    <div>
                      <div className="text-sm font-bold text-white font-manrope">{method.label}</div>
                      <div className="text-sm text-[#0158c6] font-semibold">{method.value}</div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.05)] text-white text-sm placeholder-[rgba(154,160,180,0.5)] focus:outline-none focus:border-[#0158c6] focus:bg-[rgba(255,255,255,0.08)] transition-all"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.05)] text-white text-sm focus:outline-none focus:border-[#0158c6] focus:bg-[rgba(255,255,255,0.08)] transition-all"
                    required
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.05)] text-white text-sm placeholder-[rgba(154,160,180,0.5)] focus:outline-none focus:border-[#0158c6] focus:bg-[rgba(255,255,255,0.08)] transition-all resize-none"
                    required
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full py-4 rounded-full bg-[#0158c6] text-white font-bold text-sm hover:bg-[#0199c6] transition-all shadow-[0_6px_20px_rgba(1,88,198,0.3)] flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  <Send size={16} />
