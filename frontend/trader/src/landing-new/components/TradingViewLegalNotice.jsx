  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <BarChart3 size={18} className="text-[#0158c6] shrink-0 mt-0.5" aria-hidden />
        <div>
          ...
          <p className="text-xs text-[#9AA0B4] leading-relaxed">
            Advanced charts, Stock Heatmap, and related market widgets on Bull4x are{' '}
            <strong>provided by TradingView</strong> and are subject to TradingView&apos;s terms,
            policies, and technical requirements. TradingView is a third-party service; Bull4x is
          ...
          <p className="mt-2 text-[11px] text-[#9AA0B4]/60 leading-relaxed">
            Learn more:{' '}
            <a href="https://www.tradingview.com/" target="_blank" rel="noopener noreferrer" className="text-[#0158c6] font-medium hover:underline">
              TradingView.com
            </a>
            {' · '}
            <a href="https://www.tradingview.com/policies/" target="_blank" rel="noopener noreferrer" className="text-[#0158c6] font-medium hover:underline">
              Policies &amp; terms
            </a>
            {' · '}
            <a href="https://www.tradingview.com/widget/" target="_blank" rel="noopener noreferrer" className="text-[#0158c6] font-medium hover:underline">
              Widgets
            </a>
