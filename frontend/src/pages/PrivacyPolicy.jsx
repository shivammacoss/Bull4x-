import {
  FiLock, FiShield, FiDatabase, FiShare2, FiClock, FiUser,
  FiUsers, FiLink2, FiRefreshCw, FiCheckCircle,
} from 'react-icons/fi'
import {
...
const PrivacyPolicy = () => (
  <LegalPageShell standalone>
    ...
    <LegalBody sections={sections}>
      <HighlightBanner icon={FiShield} title="Your privacy, our commitment">
      ...
      <SectionCard id="collect" no="01" icon={FiDatabase} title="Information We Collect">
        <div>
          ...
          <ul className="space-y-2">
            ...
            <Bullet><span className="text-white font-semibold">Financial Information:</span> Bank account details, UPI IDs, and payment transaction references for deposit and withdrawal processing.</Bullet>
        ...
        <div>
          ...
          <p className="mb-3">To comply with financial regulations, we collect identity verification documents including:</p>
          <ul className="space-y-2">
      ...
      <SectionCard id="use" no="02" icon={FiUser} title="How We Use Your Information">
        ...
        <ul className="space-y-2">
          ...
          <Bullet><span className="text-white font-semibold">Identity Verification:</span> To verify your identity through KYC processes as required by financial regulations.</Bullet>
      ...
      <SectionCard id="security" no="03" icon={FiShield} title="Data Storage & Security">
      ...
      <SectionCard id="sharing" no="04" icon={FiShare2} title="Data Sharing & Disclosure">
        <p>
      ...
      <SectionCard id="retention" no="05" icon={FiClock} title="Data Retention">
        <p>
        ...
        <p className="text-slate-400 text-sm">
          KYC documents are retained as required by applicable financial regulations.
        </p>
      </SectionCard>

      <SectionCard id="rights" no="06" icon={FiCheckCircle} title="Your Rights">
      ...
      <SectionCard id="children" no="07" icon={FiUsers} title="Children's Privacy">
        <p>
      ...
      <SectionCard id="third" no="08" icon={FiLink2} title="Third-Party Services">
        <p>
      ...
      <SectionCard id="updates" no="09" icon={FiRefreshCw} title="Updates to This Privacy Policy">
        <p>
