...
async def portfolio_summary(
    ...
    is_demo: bool | None = Query(
        None,
        description=(
            "Scope to demo (true) or live (false) accounts. Omit to include both. "
            "Demo and real trades are kept separate so they never aggregate together."
        ),
    ),
